...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://www.maymaymadeit.com/cart/add.js"
        headers = {
            'accept': '*/*',
        ...
        data = {
            ...
            'id': '13764036035',
            'quantity': '1',
            'product-id': '4506059395',
        }
        async with r.post(url, headers=headers, json=data, proxy=PROX) as response:
...
"""
        ...
        async with r.get('https://www.maymaymadeit.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        response = await r.post(
            'https://www.maymaymadeit.com/cart',
            headers=headers,
            data=data,
        ...
        json_data = {
            ...
            'payment_session_scope': 'maymaymadeit.com',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/13764036035',
                                        'variantId': 'gid://shopify/ProductVariant/13764036035',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://www.maymaymadeit.com/checkouts/cn/{tok}',
                    'pageId': '2adf7284-9E06-42D0-EC56-E21FFE19679A',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://www.maymaymadeit.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://www.maymaymadeit.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
