...
"""
        ...
        async with r.get('https://www.buildingnewfoundations.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/3706681860',
                                        'variantId': 'gid://shopify/ProductVariant/3706681860',
                                        'properties': [],
                                        'sellingPlanId': None,
        ...
        async with r.post('https://www.buildingnewfoundations.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://www.buildingnewfoundations.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
