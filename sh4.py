...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://cozyquilt.com/cart/add.js"
        headers = {
            'accept': '*/*',
...
"""
        ...
        async with r.get('https://cozyquilt.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        json_data = {
            ...
            'payment_session_scope': 'cozyquilt.com',
        }
...
"""
        headers = {
            ...
            'x-checkout-web-build-id': 'cd951525ec265157d75efd4dc4c70dffde049db6',
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/42198427435068',
                                        'variantId': 'gid://shopify/ProductVariant/42198427435068',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://cozyquilt.com/checkouts/cn/{tok}',
                    'pageId': '5575ec35-EB05-47E0-CC28-8A90761FE4FF',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://cozyquilt.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://cozyquilt.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
