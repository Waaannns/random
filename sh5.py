...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://littlewolf.coffee/cart/add.js"
        headers = {
...
"""
        ...
        async with r.get('https://littlewolf.coffee/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        json_data = {
            ...
            'payment_session_scope': 'littlewolf.coffee',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/37738465820849',
                                        'variantId': 'gid://shopify/ProductVariant/37738465820849',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://littlewolf.coffee/checkouts/cn/{tok}',
                    'pageId': '576a0951-99E7-4355-BA0E-891BA9ABB235',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://littlewolf.coffee/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://littlewolf.coffee/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
