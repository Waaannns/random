...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://www.connectroasters.com/cart/add.js"
        headers = {
            'accept': '*/*',
...
"""
        ...
        async with r.get('https://www.connectroasters.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        response = await r.post(
            'https://www.connectroasters.com/cart',
            headers=headers,
            data=data,
        ...
        json_data = {
            ...
            'payment_session_scope': 'connectroasters.com',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/32383837667433',
                                        'variantId': 'gid://shopify/ProductVariant/32383837667433',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://www.connectroasters.com/checkouts/cn/{tok}',
                    'pageId': '57738e52-EF4F-42D9-0657-C29542442E07',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://www.connectroasters.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://www.connectroasters.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
