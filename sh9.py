...
async def sh(message):
    ...
    async with aiohttp.ClientSession() as r:
        url = "https://ecovibestyle.com/cart/add.js"
        headers = {
...
"""
        ...
        async with r.get('https://ecovibestyle.com/cart.js', headers=headers, proxy=PROX) as response:
...
"""
        ...
        json_data = {
            ...
            'payment_session_scope': 'ecovibestyle.com',
        }
...
"""
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/42957251444963',
                                        'variantId': 'gid://shopify/ProductVariant/42957251444963',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://ecovibestyle.com/checkouts/cn/{tok}',
                    'pageId': '577982e6-451F-4011-2D7E-C59416AD436B',
                },
            },
            'operationName': 'SubmitForCompletion',
        }

        async with r.post('https://ecovibestyle.com/checkouts/unstable/graphql', params=params, headers=headers, json=json_data, proxy=PROX) as response:
            raw = await response.text()
            try:
                res_json = json.loads(raw)
...
"""
            ...
            for _ in range(max_retries):
                async with r.post('https://ecovibestyle.com/checkouts/unstable/graphql',params=params,headers=headers,json=json_data, proxy=PROX) as final_response:
